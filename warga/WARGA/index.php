...
<head>
    ...
    <script type="text/javascript" src="cetak.js"></script>
...
<body>
    <div class="container-fluid">
        <div
            ...
            <h5 class="my-0 mr-md-auto font-weight-normal text-info"><i class="fas fa-user title-icon"></i>WARGA
            </h5>
            <?php  
            ...
            &nbsp; &nbsp;
            <a class="btn btn-outline-warning" href="cetak.php" target="_blank" role="button"><i
                    class="fas fa-print"></i>
                Cetak Semua Warga</a> &nbsp; &nbsp;
            <a class="btn btn-outline-success" href="export.php" role="button"><i class="fas fa-file-excel"></i>
                Export</a>
            <?php
            } 
        ...
        <footer class="pt-4 my-md-4 pt-md-3 border-top">
            <div class="row">
                <div class="col-12 col-md center">
                    &copy; 2024 - <a class="text-info" href="#">WARGA</a>
                </div>
            </div>
        </footer>
    </div>
    ...
    function validasiFile() {
        ...
        if (!allowedExtensions.exec(filePath)) {
            ...
            document.getElementById('imagePreview').innerHTML =
                '<img class="foto-preview" src="foto/default_user.png"/>';
            return false;
        }
        ...
        // selain itu
            ...
            if (fileInput.files && fileInput.files[0]) {
                ...
                reader.onload = function(e) {
                    document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="' + e.target
                        .result + '"/>';
                };
