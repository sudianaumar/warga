	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="alert alert-info" role="alert">
	            <i class="fas fa-edit"></i> Ubah Data Warga
	        </div>
	                    ...
	                    <div class="row">
	                        <div class="col">
	                            <div class="form-group col-md-12">
	                                ...
	                                <input type="text" class="form-control" name="nip" maxlength="16"
	                                    ...
	                                    value="<?php echo $nip; ?>" readonly required>
	                            ...
	                            <div class="form-group col-md-12">
	                                ...
	                                <select class="form-control" name="tempat_lahir" autocomplete="off" required>
	                                    ...
	                                    <option value="<?php echo $tempat_lahir; ?>"><?php echo $tempat_lahir; ?></option>
	                        ...
	                        <div class="col">
	                            <div class="form-group col-md-12">
	                                ...
	                                <div class="invalid-feedback">Nama Penghuni tidak boleh kosong.</div>
	                            </div>

	                            <div class="form-group col-md-12">
	                                <label>Tanggal Lahir</label>
	                                <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy"
	                                    name="tanggal_lahir" autocomplete="off" value="<?php echo $tanggal_lahir; ?>"
	                                    required>
	                            ...
	                            <div class="form-group col-md-12">
	                                ...
	                                <select class="form-control" name="alamat" autocomplete="off" required>
	                                    ...
	                                    <option value="Saudara Pemilik">Saudara Pemilik</option>
	                                </select>
	                        ...
	                        <div class="col">
	                            <div class="form-group col-md-12">
	                                ...
	                                <div id="imagePreview"><img class="foto-preview" src="foto/<?php echo $foto; ?>" />
	                                </div>
	                            </div>
	                        </div>
	                    </div>
