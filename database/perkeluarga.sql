...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2024 at 10:41 PM
...
INSERT INTO `pegawai` (`id`, `nip`, `nama_pegawai`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `agama`, `alamat`, `no_hp`, `foto`) VALUES
(1, 'A1-1', 'KOSONG', 'warga tetap', '25-07-1959', 'P', 'ISLAM', 'ayah', '9999999', ''),
(2, 'A1-2', 'Triyono Jedul', 'Suami', 'Warga Tetap', '', '', '', '', ''),
(3, 'A1-3', 'Erdi Wishnu', 'Suami', 'Warga Tetap', '', '', '', '', ''),
(4, 'A1-4', 'Tiara', '', '', '', '', '', '', ''),
